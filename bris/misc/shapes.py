...
def get_shape_shards(
    tensor: Tensor, dim: int, model_comm_group: Optional[ProcessGroup] = None
) -> list:
    ...
    comm_size = (
        1 if not model_comm_group else dist.get_world_size(group=model_comm_group)
    )
