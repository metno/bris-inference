...
class Harp(Output):
    """This class writes verification files for Harp in Parquet format. """
    ...
    def __init__(
        ...
        """
        Args:
            units: Units to put in Harp file. Should be the same as the observations
    ...
    def finalize(self):
        ...
        pq.write_table(table, "./harptest/fil.parquet")
